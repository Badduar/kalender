-- ============================================================
--  Erinnerungszeit in die Abfrage aufnehmen
-- ============================================================
--  Sonst kann der Dialog den eingestellten Wert nicht anzeigen.
--  Sie ist nur fuer den Ersteller interessant - andere bekommen NULL.
